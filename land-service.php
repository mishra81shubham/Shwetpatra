...
<body>
    ...
    <section id="land-banner">
        <div class="land-banner">

            <h1>Land Related Services</h1>
    ...
    <section>
        <div class="container land-ser">

            <div>
                <h3 class="step-text">Step I</h3>

                <ul class="list-land">

                    <li><i class="fa-solid fa-star"></i> &nbsp;
                        <p>Organising visit for acquiring land</p>
                    </li>
            ...
            <div>
                <h3 class="step-text">Step III</h3>
                ...
                <ul class="list-land">
                    ...
                    <li><i class="fa-solid fa-star"></i> &nbsp;
                        <p>Liaisoning with the stamp duty department</p>
                    </li>
